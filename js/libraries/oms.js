...
(function () {
  var callbackName, callbackRegEx, scriptTag, tag, _ref, _ref1,
  ...
  if (scriptTag == null) {
    scriptTag = ((function () {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tag = _ref[_i];
        if ((_ref1 = tag.getAttribute('src')) != null ? _ref1.match(callbackRegEx) : void 0) {
          _results.push(tag);
        }
      }
      return _results;
  ...
  if (scriptTag != null) {
    callbackName = (_ref = scriptTag.getAttribute('src')) != null ? (_ref1 = _ref.match(callbackRegEx)) != null ? _ref1[3] : void 0 : void 0;
    if (callbackName) {
